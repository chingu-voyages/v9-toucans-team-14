      ...
      <div className="left-first-middle">
        <div className="first-middle-left">
          ...
          <div className="left-description desc">
            <h4>Description</h4>
              <p>Running sneakers with thin elastic laces. Wavy rubber sole. Made of black technical knit fabric. The rubberized film details highlight the shape of the shoe. Customized withdetachable rubber tab appliqué on the heel.
              </p>
          </div>
          ...
          <div className="composition-box desc">
            <h4>Composition</h4>
              <p>
                80% polyamide, 20% elastane, 100% calf leather, inside: 100% polyester.
              </p>
          </div>
        </div>
